      ...
      {#if analysis.healthConcerns && analysis.healthConcerns.length > 0}
        <div class="concerns">
          <div class="flex items-center space-x-1 mb-1">
            ...
            <span class="text-xs font-medium" style="color: var(--petalytics-love);">Health Concerns</span>
          </div>
      ...
      {#if analysis.recommendations && analysis.recommendations.length > 0}
        <div class="recommendations">
          <div class="flex items-center space-x-1 mb-1">
            ...
            <span class="text-xs font-medium" style="color: var(--petalytics-pine);">Recommendations</span>
          </div>
          <ul class="text-xs space-y-1" style="color: var(--petalytics-text);">
      ...
      {#if !compact && analysis.moodTrend}
        <div class="trend-info flex items-center justify-between text-xs">
          ...
          <span class="flex items-center space-x-1">
            ...
            <span style="color: var(--petalytics-text);" class:text-green-400={analysis.moodTrend === 'improving'} 
